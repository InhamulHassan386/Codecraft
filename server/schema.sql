...
CREATE TABLE IF NOT EXISTS projects (
  ...
  technologies JSON NOT NULL, results JSON NOT NULL, services JSON NULL, current_status VARCHAR(60) NOT NULL DEFAULT 'Planning', progress TINYINT UNSIGNED NOT NULL DEFAULT 0, start_date DATE NULL, expected_completion DATE NULL, assigned_team JSON NULL, project_files JSON NULL, year VARCHAR(10) NOT NULL, client VARCHAR(180) NOT NULL,
...
CREATE TABLE IF NOT EXISTS admin_users (
  ...
  password_hash VARCHAR(255) NOT NULL, role ENUM('Super Admin','Editor','Viewer') DEFAULT 'Editor', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
